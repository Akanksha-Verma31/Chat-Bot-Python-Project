'''  -----The project is all about implementing Chatbot using basic python-----  '''
...
class GUI:
    """
       This is a class for Implementing the Chatbot and Creating the GUI .

       Attributes:
           name (string): The name of the bot.
           weather (string): The weather is initialised in it.
           mood (string): Defined the mood of the bot.
           responses (dictionary): List of some pre-defined responses.
       """
    ...
    def response(self,message):
        " " " To match responses with the msg entered by the user " " "
